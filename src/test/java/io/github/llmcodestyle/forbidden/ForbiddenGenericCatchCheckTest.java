...
class ForbiddenGenericCatchCheckTest {
    ...
    void invalidCasesProduceViolations() throws Exception {
        List<AuditEvent> violations = runTreeWalkerCheck(ForbiddenGenericCatchCheck.class, "forbidden/invalid/ForbiddenGenericCatchInvalid.java", Map.of());
    ...
    void validCasesProduceNoViolations() throws Exception {
        assertTrue(runTreeWalkerCheck(ForbiddenGenericCatchCheck.class, "forbidden/valid/ForbiddenGenericCatchValid.java", Map.of()).isEmpty(), "Expected no violations");
    }
}
