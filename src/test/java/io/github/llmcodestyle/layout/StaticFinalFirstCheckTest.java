...
class StaticFinalFirstCheckTest {
    ...
    void invalidCasesProduceViolations() throws Exception {
        List<AuditEvent> violations = TestCheckSupport.runTreeWalkerCheck(StaticFinalFirstCheck.class, "invalid/StaticFinalFirstInvalid.java", Map.of());
    ...
    void validCasesProduceNoViolations() throws Exception {
        assertTrue(TestCheckSupport.runTreeWalkerCheck(StaticFinalFirstCheck.class, "valid/StaticFinalFirstValid.java", Map.of()).isEmpty(), "Expected no violations");
    }
}
