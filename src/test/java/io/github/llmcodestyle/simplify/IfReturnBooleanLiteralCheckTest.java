...
class IfReturnBooleanLiteralCheckTest {
    ...
    void semiPathDetection() throws Exception {
        ...
        assertEquals(1, violations.size(), "Should detect if-return-boolean with RCURLY siblings: " + format(violations));
    }
    ...
    void followingReturnSkipsSemiAndRcurly() throws Exception {
        ...
        assertEquals(1, violations.size(), "Should find the if-return-boolean pattern despite SEMI/RCURLY siblings: " + format(violations));
    }
