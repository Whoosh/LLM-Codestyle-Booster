...
class PureSingleUseLocalVariableCheckTest {
    ...
    void invalidCasesProduceViolations() throws Exception {
        List<AuditEvent> violations = TestCheckSupport.runTreeWalkerCheck(PureSingleUseLocalVariableCheck.class, "invalid/PureSingleUseVarInvalid.java", Map.of());
    ...
    void validCasesProduceNoViolations() throws Exception {
        assertTrue(TestCheckSupport.runTreeWalkerCheck(PureSingleUseLocalVariableCheck.class, "valid/PureSingleUseVarValid.java", Map.of()).isEmpty(), "Expected no violations");
    }
}
